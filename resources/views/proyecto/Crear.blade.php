...
<div class="container">
	...
	<div class="row my-2">
		<div class="col-sm-12">
			<div>
				<form action="{{ route('proyecto.custom.crear') }}" method="POST">
					{{csrf_field()}}
					...
					<div class="form-row my-3 p-2">
						<div class="col-sm-7 text-center mx-auto"> 
							...
							<textarea id="descripcion" type="date" class="form-control @if( $errors->has('descripcion')) is-invalid @endif" name="descripcion" value="{{ old('descripcion') }}" required cols="50" rows="4" placeholder="Descripcion" ></textarea>
