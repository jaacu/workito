    ...
    <div class="row mt-4">
        <div class="col-sm-6">
            <div class="card border-info ">
                <div class="card-body" >
                    <h5 class="card-title"><a class="text-dark" data-toggle="collapse" href="#proyectos" role="button" aria-expanded="false" aria-controls="proyectos">Proyectos Activos: <span class="text-info">{{ $proyects->count() }}</span></a> </h5>
                    ...
                    <li class="list-group-item border-info">
                        <a href="{{ route('admin.proyectos') }}" class="btn btn-primary">Ver Proyectos.</a>
                        <a href="{{ route('proyecto.crear') }}" class="btn btn-primary">Crear Nuevo Proyecto.</a>
                    </li>
                </ul>
            </div>
        </div>
